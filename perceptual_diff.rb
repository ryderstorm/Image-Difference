...
class PerceptualDiff 
  ...
  # verbose is referring to the perceptualdifference command line program
  ...
  def diff
    ...
    # consider using open4 ?? Any ideas anyone
    ...
    o.split(/\n/).each do |line|
      ...
      # Little tired of image processing. :'( Need a break i guess.
...
# Someone fix this part, tried and tried and gave up by commenting it. @yashwanth ?
